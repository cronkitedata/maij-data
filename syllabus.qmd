...
[175 points]{.quarto-title-meta-heading}
...
[225 points]{.quarto-title-meta-heading}
...
---- | -----
[115%]{.highlight} | I will award extra points when the work shows extraordinary effort, thought and engagement. You can do everything right and still receive an A+ in the course without ever seeing one of these. Instead, it's a way for me to acknowledge unusually ambitious work that goes well beyond the original assignment. 
...
I will not monitor or respond to messages in  Slack, Zoom, or email during or just before class time. The only reliable way to get me a message between 9:20 and 11:20 Mondays and Wedesdays is to do so in person in the classroom. 
...
* We all know there is a lot of flu and RSV going around this year. If you are sick, you should contact ASU Health Services or your doctor. They can provide the documentation needed to offer accommodations if you are too ill or contagious to leave home. 
...
That said, **give yourself a break**. You may get an extension on daily work twice during the semester without any penalty. This includes labs/prelabs and graded homework.  You don't need to give me a reason -- just let me know by 6pm the day before the deadline, and I'll give you an automatic 48-hour extension.  Any parts of the two major projects are not included in this policy. 
...
Sure --- for help, not for answers. In fact, one of the things it's really good at is answering the question, "Why doesn't this code work?"  You will have to determine if its answer is right and if it uses the functions and code you're responsible for mastering. But *for this purpose* I consider it similar to searching Google and Substack  or asking colleague for help. It might do a little better than the alternatives. 

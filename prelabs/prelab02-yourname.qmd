...
**Don't forget to run this code before you try anything else!**
...
Now that you've seen a little about what kinds of things you can do, try to think of a question you'd like to ask of this data. It doesn't have to be something you already know how to do, but try to keep it to something that this dataset alone could answer.

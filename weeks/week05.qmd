...
[Sunday Feb. 19]{.sked-dates} : The sentences you propose replicating for the data replication project

[Monday Feb. 20]{.sked-dates} : What would you do? 
...
* ["Banking on Inequity"](https://revealnews.org/podcast/banking-on-inequity/) , RevealNews, from reporting by Laura C. Morel, Mohamed Al Elew and Emily Harris, May 1, 2021. Pay particular attention to how they characterize the inequity -- it's based on the characteristics of Census tracts, which are further categorized with a dominant racial / ethnic group. Think about different ways you might have done this, recognizing that you only know WHERE a loan went, not the race or ethnicity of the PERSON who got the loan. This is a common problem. 

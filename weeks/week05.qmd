...
- [Sunday Feb. 12]{.sked-dates} : The sentences you propose replicating for the [data replication project](../projects/replication.qmd)
...
* [`select`, `arrange` and `filter` (with a focus on filter)]{.text-danger}: 

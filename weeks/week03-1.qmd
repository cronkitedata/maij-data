...
::: {.callout-warning}
## FIX THIS!
AGRHH ! This is backwards if I want to use the notice of claims data for the spreadsheet assignment AND the life of a dataset lab. 
Think about whether I want to use something else for the life of a dataset lab -- something a little more obvious. Consider taking 911 data out of the options for the life of a dataset and use it there. 

For life of a dataset options:  use the CDC data, maybe national park service data on visits, maybe something new from the Phoenix open government. Make it so that it's too big for them to actually get onto their computers - they can't "browse" it. 
::: 
-->
